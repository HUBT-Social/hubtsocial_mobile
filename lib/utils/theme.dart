...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(4282018107),
      surfaceTint: Color(4282018107),
      onPrimary: Color(4294967295),
      primaryContainer: Color(4290506934),
      ...
      inversePrimary: Color(4288664731),
      primaryFixed: Color(4290506934),
      onPrimaryFixed: Color(4278198533),
      primaryFixedDim: Color(4288664731),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(4288664731),
      surfaceTint: Color(4288664731),
      onPrimary: Color(4278663441),
      primaryContainer: Color(4280373285),
      onPrimaryContainer: Color(4290506934),
      ...
      inversePrimary: Color(4282018107),
      primaryFixed: Color(4290506934),
      onPrimaryFixed: Color(4278198533),
      primaryFixedDim: Color(4288664731),
      onPrimaryFixedVariant: Color(4280373285),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(4288927903),
      onPrimaryContainer: Color(4278190080),
      ...
      primaryFixedDim: Color(4288927903),
